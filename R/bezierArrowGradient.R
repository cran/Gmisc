...
bezierArrowGradient <- function(x = c(0.2, .7, .3, .9),
  ...
  if ("grdt_start_prop" %in% names(list(...)))
    stop("The grdt_start_prop has been deprecated. Switch to grdt_prop instead.",
  ...
  grdt_line_width <- getAbsoluteWidth(w = grdt_line_width,
                                      default.units = default.units,
                                      x = x,
                                      y = y)
